...
| **frontend** | 전 범주 디자인 + FE 개발 | headless `/goal` 서브프로세스 (worktree) | design-consultation/shotgun/html, design-review, review, ship, qa | ui-ux-designer + brand-designer + dev(FE) |
...
- **작업단위 = 수직 Feature 슬라이스**, 한 소유자가 end-to-end. 작업 중 분할/파편 티켓 ❌. → `config/work-unit-contract.md`
